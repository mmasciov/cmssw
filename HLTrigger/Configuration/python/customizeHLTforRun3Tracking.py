...
### Default standard tracking + displaced iter-4 for taus using ALL pixel vertices
def customizeHLTforRun3TrackingPlusIter4ForTauAllPixelVertices(process):
...
### Using quadruplet pixel tracks from any pixel vertex, plus iter-4 for taus using trimmed pixel vertices
def customizeHLTforRun3TrackingAllPixelVerticesPlusIter4ForTau(process):
...
### Using quadruplet pixel tracks from any pixel vertex, plus iter-4 for taus using all pixel vertices
def customizeHLTforRun3TrackingAllPixelVerticesPlusIter4ForTauAllPixelVertices(process):
