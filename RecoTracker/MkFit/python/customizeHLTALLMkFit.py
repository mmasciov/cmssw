...
def customizeHLTIter0ToMkFit(process):
    ...
    process.hltIter0PFlowTrackCutClassifier.mva.maxChi2 = cms.vdouble( 999.0, 99.0, 99.0 )
    ...
    if hasattr(process, 'hltIter0PFlowTrackCutClassifierSerialSync'):
        process.hltIter0PFlowTrackCutClassifierSerialSync.mva.maxChi2 = cms.vdouble( 999.0, 99.0, 99.0 )
...
def customizeHLTDoubletRecoveryToMkFit(process):
    ...
    process.hltDoubletRecoveryPFlowCkfTrackCandidatesMkFit = mkFitProducer_cfi.mkFitProducer.clone(
        ...
        config = ('', 'hltDoubletRecoveryPFlowTrackCandidatesMkFitConfig'),
        minGoodStripCharge = dict(refToPSet_ = 'HLTSiStripClusterChargeCutNone'),
    )
